...
Tässä näkymässä voidaan lisätä asukkaita asuntoihin ja syöttää heidän tiedot, tässä tapauksessa nimi, syntymävuosi ja sähköposti. Vääränlaisen datan syöttämisen värjää tekstiruudun punaiseksi.
...
Samaa asukasta ei voi myöskään syöttää kahta kertaa, eli jos nimi ja syntymävuosi löytyvät jo -> esto. Usealla asukkaalla tosin voi olla yhteinen spostiosoite.


Muokkaa nappulassa päästään seuraavaan näkymään, joka sisältää asukkaan tiedot, (muokkaaminen sisältää samat validoinnit kuin lisäys) ja napit tallentamiseen ja sulkemiseen:
![img_5.png](img_5.png)
...
Seppo saa nyt toistaiseksi jäädä asustelemaan ja Tepon lisäksi lisätty Matti.

![img_10.png](img_10.png)

Asunnossa A3 on nyt kolme asukasta: 
